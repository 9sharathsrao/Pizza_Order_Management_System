    ...
    <div class="container-fluid">
        <div class="main-content d-flex flex-column">
            ...
            <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
                <h3 class="mb-sm-0 mb-1 fs-18">Pizza Toppings List</h3>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-11">
                    <div class="card bg-white border-0 rounded-10 mb-4">
                        <div class="card-body p-4">
                            <h4 class="fs-18 mb-4">Pizza Toppings List</h4>
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        ...
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            foreach ($row as $key => $value) {
                                                                if ($key === $primaryKey || $key === "Created_at" || $key === "Updated_at" || $key === "Deleted_at") {
                                                                    continue; // Skip timestamps and primary key column
                                                                }
                                                                echo "<td>" . $value . "</td>";
                                                            }
                                                            echo "</tr>";
